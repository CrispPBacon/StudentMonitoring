...
export function CardID({ student_id, program, display_photo, type }: CardType) {
    const borderColor = type == "entry" ? "border-green-400" : "border-red-400"

    return (
        <div className="z-10 before:top-0 before:left-0 before:-z-10 before:w-full before:h-full before:bg-black before:opacity-75 before:absolute ">
